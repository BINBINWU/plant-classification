...
history = model.fit_generator(
    ...
    callbacks=[ModelCheckpoint("/home/ubuntu/Deep-Learning/plant-classification/pre_pc.h5", monitor="val_loss", save_best_only=True)]
...
plt.savefig('pretrain_imgAG_acc_vs_val_acc.png')
plt.show()
...
plt.savefig('pretrain_imgAG_loss_vs_val_loss.png')
plt.show()